...
class Car {
  ...
  drive(distance) {
    var fuelNeeded = distance / this.milesPerGallon;
...
class Instructor extends Lambdasian {
  constructor(attrbs) {
    super(attrbs); 
    this.specialty = attrbs.specialty;
    this.favLanguage = attrbs.favLanguage;
    this.catchPhrase = attrbs.catchPhrase;
  }
  ...
  grade(student, subject) {
    return `${student.name} receives a perfec tscore on ${subject}`;
  }
